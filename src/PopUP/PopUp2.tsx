            ...
            {popUp && (
                <div className="modal fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="modal-content relative bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto animate-fadeIn">
                        <h1 className="text-2xl font-semibold mb-4">Récapitulatif</h1>
                        <p className="text-gray-600 mb-6 text-center">
                        Ici, vous trouverez le récapitulatif des statistiques concertant votre sommeil et les différents éléments qui sont concernés.
                        </p>
                        <button 
